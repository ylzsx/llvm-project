...
# RUN: llvm-objdump -td --no-show-raw-insn %t.32o | FileCheck --check-prefixes=NORELAX %s
# RUN: llvm-objdump -td --no-show-raw-insn %t.64o | FileCheck --check-prefixes=NORELAX %s
...
# NORELAX-NEXT:    10000:  pcalau12i     $a0, 1024
# NORELAX-NEXT:            addi.{{[dw]}} $a0, $a0, 0
# NORELAX-NEXT:            pcalau12i     $a0, 1024
# NORELAX-NEXT:            ld.{{[dw]}}   $a0, $a0, {{[84]}}
# NORELAX-NEXT:            pcalau12i     $a0, 1024
# NORELAX-NEXT:            addi.{{[dw]}} $a0, $a0, 0
# NORELAX-NEXT:            pcalau12i     $a0, 1024
# NORELAX-NEXT:            ld.{{[dw]}}   $a0, $a0, {{[84]}}
